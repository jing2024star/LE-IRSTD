...
from ultralytics.nn.Efficient import stem,MBConvBlock
from ultralytics.nn.fasternet import embedfasternet,BSBlock,mergefasternet
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 , C2f_CA, C2f_SE, C2f_ECA, C2f_CBAM,
                 C2f_SimAM, C2f_CoT, C2f_Double, C2f_SK,
                 ...
                 BSBlock, embedfasternet, mergefasternet,AVCStem,VoVGSCSPC,GSConv
